...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ec_brucelosis (ec_brucelosis_vacuna, ec_brucelosis_dosis, ec_brucelosis_costo, ec_brucelosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_brucelosis 
                    SET ec_brucelosis_vacuna = :vacuna, 
                        ec_brucelosis_dosis = :dosis, 
                        ec_brucelosis_costo = :costo, 
                        ec_brucelosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_brucelosis WHERE id = :id";
