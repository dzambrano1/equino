...
try {
    // Fetch all purchases ordered by date from equino table
...
<title>Equino Register Compras</title>
<!-- Link to the Favicon -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" name="raza" id="newRaza" required>
                                            ...
                                            $sql_razas = "SELECT DISTINCT razas_nombre FROM ec_razas ORDER BY razas_nombre";
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" name="etapa" id="newEtapa" required>
                                            ...
                                            $sql_etapa = "SELECT DISTINCT etapas_nombre FROM ec_etapas ORDER BY etapas_nombre";
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" name="grupo" id="newGrupo" required>
                                            ...
                                            $sql_grupos = "SELECT DISTINCT grupos_nombre FROM ec_grupos ORDER BY grupos_nombre";
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" name="estatus" id="newEstatus" required>
                                            ...
                                            $sql_estatus = "SELECT DISTINCT estatus_nombre FROM ec_estatus ORDER BY estatus_nombre";
...
document.getElementById('updateModal').addEventListener('shown.bs.modal', function () {
  ...
  <!-- DataTable for equino_compra records -->
      ...
      <div class="table-responsive">
          <table id="compraTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get purchase data directly from equino table
                      $compraQuery = "SELECT 
                                        id, 
                  ...
                  foreach ($compraData as $row) {
                      ...
                      // Render row using equino table columns
                      echo "<tr>";
                      ...
                      echo "<td class='text-center'>" . htmlspecialchars($row['animal_nombre'] ?? 'N/A') . "</td>"; // equino.nombre                      
                      echo "<td class='text-center'>" . htmlspecialchars($row['fecha_compra_formatted'] ?? 'N/A') . "</td>"; // Use formatted fecha_compra
                      echo "<td class='text-center'>" . htmlspecialchars($row['tagid'] ?? '') . "</td>"; // equino.tagid
                      echo "<td class='text-center'>" . htmlspecialchars($row['precio_compra'] ?? '0.00') . "</td>"; // equino.precio_compra
                      echo "<td class='text-center'>" . htmlspecialchars($row['peso_compra'] ?? '0.00') . "</td>"; // equino.peso_compra
                      echo "</tr>";
                  }
                  ?>
              </tbody>
...
$(document).ready(function() {
    ...
    $('.edit-compra').click(function() {
        ...
        $.ajax({
            url: 'equino_get_details.php', // Assuming this endpoint exists
            type: 'GET',
            data: { tagid: tagid },
            dataType: 'json',
