...
<title>equino Register Nacimientos</title>
<!-- Link to the Favicon -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (createEntryForm) {
            ...
            createEntryForm.addEventListener('submit', function(event) {
                ...
                fetch('equino_nacimientos_create.php', {
                    method: 'POST',
                    body: formData
                })
...
function saveUpdates() {
    ...
    // Send the update request
        $.ajax({
        url: 'equino_nacimiento_update.php',
            type: 'POST',
        data: formData,
      ...
      <div class="table-responsive">
          <table id="nacimientoTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get nacimiento data directly from equino table
...
$(document).ready(function() {
    ...
    $('.edit-nacimiento').click(function() {
        ...
        $.ajax({
            url: 'equino_nacimientos_get_details.php',
            type: 'GET',
            data: { tagid: tagid },
            dataType: 'json',
    ...
    $('.delete-nacimiento').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Send AJAX request to delete the equino record
                $.ajax({
                    url: 'equino_delete.php', // Target the equino delete script
                    type: 'POST',
                    data: {
