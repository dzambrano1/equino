...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ec_grupos (ec_grupos_nombre) VALUES (:grupos)";
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_grupos SET ec_grupos_nombre = :grupos WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_grupos WHERE id = :id";
