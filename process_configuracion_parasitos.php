...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ec_parasitos (ec_parasitos_vacuna, ec_parasitos_dosis, ec_parasitos_costo, ec_parasitos_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_parasitos 
                    SET ec_parasitos_vacuna = :vacuna, 
                        ec_parasitos_dosis = :dosis, 
                        ec_parasitos_costo = :costo, 
                        ec_parasitos_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_parasitos WHERE id = :id";
