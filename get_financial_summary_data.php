...
try {
    ...
    $milkDataUrl = 'http://localhost/equino/get_milk_revenue_data.php';
    ...
    $salesDataUrl = 'http://localhost/equino/get_sales_data.php';
    ...
    $feedExpenses = [
        'concentrado' => ['table' => 'eh_concentrado', 'price_field' => 'eh_concentrado_costo', 'qty_field' => 'eh_concentrado_racion'],
        'melaza' => ['table' => 'eh_melaza', 'price_field' => 'eh_melaza_costo', 'qty_field' => 'eh_melaza_racion'],
        'sal' => ['table' => 'eh_sal', 'price_field' => 'eh_sal_costo', 'qty_field' => 'eh_sal_racion']
    ];
    ...
    $healthExpenses = [
        'eh_aftosa' => 'eh_aftosa_costo',
        'eh_brucelosis' => 'eh_brucelosis_costo', 
        'eh_ibr' => 'eh_ibr_costo',
        'eh_cbr' => 'eh_cbr_costo',
        'eh_carbunco' => 'eh_carbunco_costo',
        'eh_garrapatas' => 'eh_garrapatas_costo',
        'eh_lombrices' => 'eh_lombrices_costo'
    ];
