...
try {
    ...
    // *** IMPORTANT: Assumes ration weight column is eh_concentrado_racion ***
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $daily_feed_kg = (float)$row['eh_concentrado_racion']; // Get the daily ration weight
