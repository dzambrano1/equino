...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ec_carbunco (ec_carbunco_vacuna, ec_carbunco_dosis, ec_carbunco_costo, ec_carbunco_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_carbunco 
                    SET ec_carbunco_vacuna = :vacuna, 
                        ec_carbunco_dosis = :dosis, 
                        ec_carbunco_costo = :costo, 
                        ec_carbunco_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_carbunco WHERE id = :id";
