...
<title>Registros de Peso (equino)</title>
<!-- Link to the Favicon -->
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Registros de Peso - equino</h2>
            ...
            <tbody>
                ...
                try {
                    ...
                    if (isset($_GET['search']) && !empty($_GET['search'])) {
                        $pesoQuery .= " WHERE p.eh_peso_tagid = :tagid";
                        $tagid = $_GET['search'];
                    }
                    
                    $pesoQuery .= " ORDER BY p.eh_peso_fecha DESC";
    ...
    <div class="mt-4 text-center">
        <a href="equino_historial.php" class="btn btn-primary">Volver a Historial</a>
    </div>
</div>
