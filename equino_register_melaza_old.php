                  ...
                  try {
                      // Query to get all Animals and ALL their melaza records (if any)
                        $melazaQuery = "
                            ...
                            FROM
                                equino b
                            LEFT JOIN
                                eh_melaza c ON b.tagid = c.eh_melaza_tagid -- Join ALL matching melaza records
                            ORDER BY
                      ...
                      if (empty($melazaData)) {
                          ...
                          foreach ($melazaData as $row) {
                              ...
                              $melazaFecha = $row['eh_melaza_fecha'] ?? null;
                              ...
                              echo "<td>" . ($hasMelaza ? htmlspecialchars($row['eh_melaza_etapa'] ?? '') : 'N/A') . "</td>";
