...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ec_aftosa (ec_aftosa_vacuna, ec_aftosa_dosis, ec_aftosa_costo, ec_aftosa_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_aftosa 
                    SET ec_aftosa_vacuna = :vacuna, 
                        ec_aftosa_dosis = :dosis, 
                        ec_aftosa_costo = :costo, 
                        ec_aftosa_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_aftosa WHERE id = :id";
