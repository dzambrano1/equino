    ...
    <div class="container-fluid">
        <div class="row w-100">
            <div class="col-12 d-flex justify-content-center align-items-center">
                ...
                <i class="fas fa-clipboard-list me-2"></i>REGISTROS EQUINOS<span class="ms-2"><i class="fas fa-file-medical"></i></span>
                </h1>
            </div>
        </div>
    </div>
...
<div class="container scroll-icons-container">
    <div class="container salud-container" data-category="SALUD">
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                onclick="window.location.href='./equino_register_aftosa.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                onclick="window.location.href='./equino_register_brucelosis.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                onclick="window.location.href='./equino_register_carbunco.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                aria-expanded="false"
                aria-controls="ibr"
                onclick="window.location.href='./equino_register_ibr.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                aria-expanded="false"
                aria-controls="cbr"
                onclick="window.location.href='./equino_register_cbr.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                onclick="window.location.href='./equino_register_parasitos.php'">
    ...
    <div class="container poblacion-container" data-category="POBLACION">
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                onclick="window.location.href='./equino_register_compras.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button"
                ...
                onclick="window.location.href='./equino_register_ventas.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button"
                ...
                onclick="window.location.href='./equino_register_decesos.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button"
                ...
                onclick="window.location.href='./equino_register_descarte.php'">
    ...
    <div class="container reproduccion-container" data-category="REPRODUCCION">
        <div class="d-flex flex-column align-items-center">    
            ...
            onclick="window.location.href='./equino_register_inseminacion.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            ...
            onclick="window.location.href='./equino_register_gestacion.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            ...
            aria-expanded="false"
            aria-controls="parto"
            onclick="window.location.href='./equino_register_parto.php'">
        ...
        <div class="d-flex flex-column align-items-center">
            ...
            onclick="window.location.href='./equino_register_destete.php'">
    ...
    <div class="container alimentacion-container" data-category="ALIMENTACION">
        <div class="d-flex flex-column align-items-center">
            ...
            aria-expanded="false"   
            aria-controls="feed"  
            onclick="window.location.href='./equino_register_feed.php'">    
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                onclick="window.location.href='./equino_register_melaza.php'"> 
        ...
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                aria-expanded="false"   
                aria-controls="sal"  
                onclick="window.location.href='./equino_register_sal.php'">
    ...
    <div class="container produccion-container" data-category="GANANCIA PESO">
        <div class="d-flex flex-column align-items-center">
            <button class="btn btn-outline-secondary mb-1" type="button" 
                ...
                aria-expanded="false"   
                aria-controls="carne"  
                onclick="window.location.href='./equino_register_meat.php'">
