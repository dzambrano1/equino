...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO ec_sal (ec_sal_nombre, ec_sal_etapa, ec_sal_racion, ec_sal_costo, ec_sal_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_sal 
                    SET ec_sal_nombre = :sal, 
                        ec_sal_etapa = :etapa,
                        ec_sal_racion = :racion, 
                        ec_sal_costo = :costo, 
                        ec_sal_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_sal WHERE id = :id";
