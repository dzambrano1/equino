...
try {
    ...
    $vaccinatedQuery = "SELECT 
                            COUNT(DISTINCT a.eh_mastitis_tagid) AS vaccinated_animals
                        FROM equino v 
                        LEFT JOIN eh_mastitis a ON v.tagid = a.eh_mastitis_tagid
                        WHERE v.grupo = ? AND a.eh_mastitis_tagid IS NOT NULL";
    ...
    $totalQuery = "SELECT COUNT(*) AS total_animals FROM equino WHERE grupo = ?";
    ...
    $nonVaccinatedListQuery = "SELECT v.tagid, v.nombre 
                               FROM equino v 
                               LEFT JOIN eh_mastitis a ON v.tagid = a.eh_mastitis_tagid
                               WHERE v.grupo = ? AND a.eh_mastitis_tagid IS NULL
