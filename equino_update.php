...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $checkQuery = "SELECT COUNT(*) as count FROM equino WHERE tagid = ?";
            ...
            if ($result['count'] > 0) {
                ...
                $sql = "UPDATE equino SET " . implode(", ", $set_clauses) . " WHERE tagid = :tagid";
                ...
                echo json_encode([
                    ...
                    "redirect" => "equino_register_compras.php"
                ]);
            } else {
                ...
                $sql = "INSERT INTO equino (" . implode(", ", $fields) . ") VALUES (" . implode(", ", $placeholders) . ")";
        ...
        case 'update':
            ...
            $sql = "UPDATE equino SET " . implode(", ", $set_clauses) . " WHERE id = :id";
        ...
        case 'delete':
            ...
            $sql = "UPDATE equino SET fecha_compra = NULL, peso_compra = NULL, precio_compra = NULL WHERE tagid = :tagid";
        ...
        case 'delete_nacimiento':
            ...
            $sql = "UPDATE equino SET fecha_nacimiento = NULL, peso_nacimiento = NULL WHERE tagid = :tagid";
    ...
    error_log("Error in equino_update.php: " . $e->getMessage());
