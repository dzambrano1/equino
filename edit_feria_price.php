...
if (empty($tagid)) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($precio_venta <= 0) {
            ...
            // Update animal price
            $update_sql = "UPDATE equino SET precio_venta = ?, fecha_publicacion = NOW() WHERE tagid = ?";
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="alert alert-success">
                    ...
                    <div class="mt-2">
                        <a href="equino_feria.php" class="btn btn-sm btn-primary">
                    ...
                    <div class="col-md-8">
                        ...
                        <form method="post" action="" class="mt-4">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="equino_feria.php" class="btn btn-secondary">
