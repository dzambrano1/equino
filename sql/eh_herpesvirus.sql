...
--
-- Table structure for table `eh_herpesvirus`
--

CREATE TABLE `eh_herpesvirus` (
  `id` int(11) NOT NULL,
  `eh_herpesvirus_tagid` varchar(10) NOT NULL,
  `eh_herpesvirus_producto` varchar(50) NOT NULL,
  `eh_herpesvirus_dosis` decimal(10,2) NOT NULL,
  `eh_herpesvirus_costo` decimal(10,2) NOT NULL,
  `eh_herpesvirus_fecha` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `eh_herpesvirus`
--

INSERT INTO `eh_herpesvirus` (`id`, `eh_herpesvirus_tagid`, `eh_herpesvirus_producto`, `eh_herpesvirus_dosis`, `eh_herpesvirus_costo`, `eh_herpesvirus_fecha`) VALUES
...
--
-- Indexes for table `eh_herpesvirus`
--
ALTER TABLE `eh_herpesvirus`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `eh_herpesvirus`
--
ALTER TABLE `eh_herpesvirus`
