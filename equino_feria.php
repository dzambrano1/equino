...
if (!isset($conn) || !($conn instanceof PDO)) {
    error_log("equino_feria.php failed: PDO connection not available in pdo_conexion.php");
...
try {
    $base_filter_query = "FROM equino WHERE estatus = 'Feria' AND precio_venta > 0";
...
if ($user_role === 'admin' && $_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'new_listing') {
    ...
    if (empty($tagid) || $precio_venta === false || $precio_venta <= 0) {
        ...
        try {
            ...
            $check_sql = "SELECT tagid, estatus FROM equino WHERE tagid = :tagid";
            ...
            if (!$animal_data) {
                ...
                // Update equino record with precio_venta, fecha_publicacion, and estatus
                $update_sql = "UPDATE equino SET precio_venta = :precio_venta, fecha_publicacion = :fecha, estatus = 'Feria' WHERE tagid = :tagid";
                ...
                if ($update_stmt->execute()) {
                    ...
                    $my_animals_query = "SELECT tagid, nombre, genero, raza FROM equino WHERE estatus != 'Feria' ORDER BY nombre";
                    $my_animals_stmt = $conn->query($my_animals_query);
                    $my_animals = $my_animals_stmt->fetchAll(PDO::FETCH_ASSOC);
                } else {
            ...
            <div class="nav-links-container d-flex justify-content-center">
                <div class="nav-link-item text-center mx-3">
                    ...
                    <div>
                        ...
                        <a class="nav-link active" href="equino_feria.php">PUBLICADOS</a> 
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="productForm" method="post" action="equino_feria.php"> <!-- Post back to self -->
