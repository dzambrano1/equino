...
try {
    // Query to get total monthly weight from eh_peso table
    // Assumes date column is eh_peso_fecha and weight column is eh_peso_animal	
    ...
    $sql = "
        ...
        FROM eh_peso 
        WHERE eh_peso_animal	 > 0 -- Optionally filter out zero or invalid weights
        GROUP BY month 
        ORDER BY month ASC;
    ";
