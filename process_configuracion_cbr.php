...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ec_cbr (ec_cbr_vacuna, ec_cbr_dosis, ec_cbr_costo, ec_cbr_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_cbr 
                    SET ec_cbr_vacuna = :vacuna, 
                        ec_cbr_dosis = :dosis, 
                        ec_cbr_costo = :costo, 
                        ec_cbr_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_cbr WHERE id = :id";
