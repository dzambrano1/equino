...
if (isset($_GET['fix']) && $_GET['fix'] == 1) {
    ...
    $fix_query = "UPDATE equino SET estatus = 'Feria' WHERE precio > 0";
...
<head>
    ...
    <title>Debug equino - Animals with Price</title>
...
<body>
    <div class="container">
        ...
        <?php if ($result && $result->num_rows > 0): ?>
            ...
            <a href="debug_equino.php?fix=1" class="btn btn-primary btn-fix">Update All to 'Feria' Status</a>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <?php
                $status_query = "SELECT DISTINCT estatus FROM equino";
        ...
        <a href="equino_feria.php" class="btn btn-secondary">Back to Feria</a>
    </div>
</body>
</html>
<?php
