...
try {
    ...
    // First, get all distinct groups from the equino database
    $sql_groups = "SELECT DISTINCT grupo FROM equino WHERE grupo IS NOT NULL AND grupo != '' ORDER BY grupo";
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT a.eh_carbunco_tagid) AS vaccinated_animals
        FROM equino v
        LEFT JOIN eh_carbunco a ON v.tagid = a.eh_carbunco_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN eh_carbunco a ON v.tagid = a.eh_carbunco_tagid
        WHERE v.grupo IS NOT NULL AND v.grupo != ''
          AND a.eh_carbunco_tagid IS NULL
