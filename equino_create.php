...
try {
    ...
    $check_sql = "SELECT COUNT(*) as count FROM equino WHERE tagid = ?";
    ...
    $sql = "INSERT INTO equino (tagid, nombre, fecha_nacimiento, fecha_compra, genero, raza, grupo, estatus, image, image2, image3, video) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
