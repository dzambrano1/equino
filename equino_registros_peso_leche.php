...
<title>equino Registros Pesaje Animal</title>
<!-- Link to the Favicon -->
...
<div class="container text-center">
  ...
  <!-- DataTable for eh_peso records -->
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="eh_pesoTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all eh_peso records with animal name
                      ...
                      if (empty($pesosData)) {
                          ...
                          foreach ($pesosData as $row) {
                              ...
                              echo "<td>" . htmlspecialchars($row['eh_peso_fecha'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['animal_nombre'] ?? 'N/A') . "</td>";
                              echo "<td>" . htmlspecialchars($row['eh_peso_tagid'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['eh_peso_animal'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['eh_peso_precio'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['total_value'] ?? '') . "</td>";
                              
                              // Calculate due date and determine status
                              try {
                                  $pesoDate = new DateTime($row['eh_peso_fecha']);
                                  ...
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['eh_peso_fecha']);
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-peso" 
                                          ...
                                          data-tagid="' . htmlspecialchars($row['eh_peso_tagid'] ?? '') . '"
