...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO ec_melaza (ec_melaza_nombre, ec_melaza_etapa, ec_melaza_racion, ec_melaza_costo, ec_melaza_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_melaza 
                    SET ec_melaza_nombre = :melaza, 
                        ec_melaza_etapa = :etapa,
                        ec_melaza_racion = :racion, 
                        ec_melaza_costo = :costo, 
                        ec_melaza_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_melaza WHERE id = :id";
