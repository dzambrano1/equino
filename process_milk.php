...
if (isset($_POST['action'])) {
    ...
    try {
        ...
        if ($action === 'insert') {
            ...
            // Execute query
            $stmt = $conn->prepare("INSERT INTO eh_leche (eh_leche_tagid, eh_leche_peso, eh_leche_precio, eh_leche_fecha_inicio) VALUES (?, ?, ?, ?)");
        ...
        // UPDATE operation
            ...
            // Execute query
            $stmt = $conn->prepare("UPDATE eh_leche SET eh_leche_tagid = ?, eh_leche_peso = ?, eh_leche_precio = ?, eh_leche_fecha_inicio = ? WHERE id = ?");
