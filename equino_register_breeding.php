...
<title>equino Register Breeding</title>
<!-- Link to the Favicon -->
...
<div class="container text-center">
  ...
  <!-- DataTable for eh_inseminacion records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="eh_inseminacionTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all eh_inseminacion records with animal name
                      $inseminacionQuery = "SELECT c.*, v.nombre as animal_nombre
                                FROM eh_inseminacion c 
                                LEFT JOIN equino v ON c.eh_inseminacion_tagid = v.tagid 
                                ORDER BY c.eh_inseminacion_fecha DESC";
                      ...
                      if (empty($inseminacionData)) {
                          ...
                          foreach ($inseminacionData as $row) {
                              ...
                              try {
                                  $inseminacionDate = new DateTime($row['eh_inseminacion_fecha']);
                                  ...
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['eh_inseminacion_fecha']);
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-inseminacion" 
                                          ...
                                          data-tagid="' . htmlspecialchars($row['eh_inseminacion_tagid'] ?? '') . '"
...
$(document).ready(function() {
    $('#eh_inseminacionTable').DataTable({
...
<div class="container text-center">
  ...
  <!-- DataTable for eh_gestacion records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="eh_gestacionTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all eh_gestacion records with animal name
                      $gestacionQuery = "SELECT c.*, v.nombre as animal_nombre
                                FROM eh_gestacion c 
                                LEFT JOIN equino v ON c.eh_gestacion_tagid = v.tagid 
                                ORDER BY c.eh_gestacion_fecha DESC";
                      ...
                      if (empty($gestacionData)) {
                          ...
                          foreach ($gestacionData as $row) {
                              ...
                              // Calculate due date and determine status
                              try {
                                  $gestacionDate = new DateTime($row['eh_gestacion_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['eh_gestacion_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-gestacion" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['eh_gestacion_tagid'] ?? '') . '"
...
$(document).ready(function() {
    ...
    function populateAnimalFilter(data) {
        ...
        data.forEach(item => {
            if (item.eh_gestacion_tagid && !uniqueTagIds.has(item.eh_gestacion_tagid)) {
                uniqueTagIds.add(item.eh_gestacion_tagid);
                animals.push({
                    tagid: item.eh_gestacion_tagid,
                    nombre: item.animal_nombre || 'Sin nombre'
                });
            }
        });
    ...
    function updateChart() {
        ...
        // Filter by animal if not "all"
        if (selectedAnimal !== 'all') {
            filteredData = filteredData.filter(item => item.eh_gestacion_tagid === selectedAnimal);
        }
        
        // Sort data by date
        filteredData.sort((a, b) => new Date(a.eh_gestacion_fecha) - new Date(b.eh_gestacion_fecha));
    ...
    function createGestacionChart(data) {
        ...
        var labels = data.map(function(item) {
            // Format the date for display
            var parts = item.eh_gestacion_fecha.split('-');
            if (parts.length === 3) {
                return parts[2] + '/' + parts[1] + '/' + parts[0];
            }
            return item.eh_gestacion_fecha;
        });
        
        var numero = data.map(function(item) {
            return item.eh_gestacion_numero;
        });
...
<div class="container text-center">
  ...
  <!-- DataTable for eh_parto records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="eh_partoTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  ...
                  try {
                      ...
                      $partoQuery = "SELECT c.*, v.nombre as animal_nombre
                                FROM eh_parto c 
                                LEFT JOIN equino v ON c.eh_parto_tagid = v.tagid 
                                ORDER BY c.eh_parto_fecha DESC";
                      ...
                      if (empty($partoData)) {
                          ...
                          foreach ($partoData as $row) {
                              ...
                              // Calculate due date and determine status
                              try {
                                  $partoDate = new DateTime($row['eh_parto_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['eh_parto_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-parto" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['eh_parto_tagid'] ?? '') . '"
...
$(document).ready(function() {
    ...
    function populateAnimalFilter(data) {
        ...
        data.forEach(item => {
            if (item.eh_parto_tagid && !uniqueTagIds.has(item.eh_parto_tagid)) {
                uniqueTagIds.add(item.eh_parto_tagid);
                animals.push({
                    tagid: item.eh_parto_tagid,
                    nombre: item.animal_nombre || 'Sin nombre'
                });
            }
        });
    ...
    function updateChart() {
        ...
        // Filter by animal if not "all"
        if (selectedAnimal !== 'all') {
            filteredData = filteredData.filter(item => item.eh_parto_tagid === selectedAnimal);
        }
        
        // Sort data by date
        filteredData.sort((a, b) => new Date(a.eh_parto_fecha) - new Date(b.eh_parto_fecha));
    ...
    function createPartoChart(data) {
        ...
        var labels = data.map(function(item) {
            // Format the date for display
            var parts = item.eh_parto_fecha.split('-');
            if (parts.length === 3) {
                return parts[2] + '/' + parts[1] + '/' + parts[0];
            }
            return item.eh_parto_fecha;
        });
        
        var numero = data.map(function(item) {
            return item.eh_parto_numero;
        });
...
<div class="container text-center">
  ...
  <!-- DataTable for eh_destete records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="eh_desteteTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  ...
                  try {
                      ...
                      $desteteQuery = "SELECT c.*, v.nombre as animal_nombre
                                FROM eh_destete c 
                                LEFT JOIN equino v ON c.eh_destete_tagid = v.tagid 
                                ORDER BY c.eh_destete_fecha DESC";
                      ...
                      if (empty($desteteData)) {
                          ...
                          foreach ($desteteData as $row) {
                              ...
                              // Calculate due date and determine status
                              try {
                                  $desteteDate = new DateTime($row['eh_destete_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['eh_destete_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-destete" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['eh_destete_tagid'] ?? '') . '"
...
$(document).ready(function() {
    ...
    function populateAnimalFilter(data) {
        ...
        data.forEach(item => {
            if (item.eh_destete_tagid && !uniqueTagIds.has(item.eh_destete_tagid)) {
                uniqueTagIds.add(item.eh_destete_tagid);
                animals.push({
                    tagid: item.eh_destete_tagid,
                    nombre: item.animal_nombre || 'Sin nombre'
                });
            }
        });
    ...
    function updateChart() {
        ...
        // Filter by animal if not "all"
        if (selectedAnimal !== 'all') {
            filteredData = filteredData.filter(item => item.eh_destete_tagid === selectedAnimal);
        }
        
        // Sort data by date
        filteredData.sort((a, b) => new Date(a.eh_destete_fecha) - new Date(b.eh_destete_fecha));
    ...
    function createDesteteChart(data) {
        ...
        var labels = data.map(function(item) {
            ...
            return item.eh_destete_fecha;
        });
        
        var peso = data.map(function(item) {
            return item.eh_destete_peso;
        });
