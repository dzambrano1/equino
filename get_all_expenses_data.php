...
try {
    ...
    $expenseCategories = [
        ...
        'feed' => [
            'Concentrado' => ['table' => 'eh_concentrado', 'date_field' => 'eh_concentrado_fecha_inicio', 'qty_field' => 'eh_concentrado_racion', 'price_field' => 'eh_concentrado_costo'],
            'Melaza' => ['table' => 'eh_melaza', 'date_field' => 'eh_melaza_fecha_inicio', 'qty_field' => 'eh_melaza_racion', 'price_field' => 'eh_melaza_costo'],
            'Sal' => ['table' => 'eh_sal', 'date_field' => 'eh_sal_fecha_inicio', 'qty_field' => 'eh_sal_racion', 'price_field' => 'eh_sal_costo']
        ],
        // Health/vaccine expenses (doses × cost or single cost)
        'health' => [
            'Aftosa' => ['table' => 'eh_aftosa', 'date_field' => 'eh_aftosa_fecha', 'qty_field' => 'eh_aftosa_dosis', 'price_field' => 'eh_aftosa_costo'],
            'Brucelosis' => ['table' => 'eh_brucelosis', 'date_field' => 'eh_brucelosis_fecha', 'qty_field' => 'eh_brucelosis_dosis', 'price_field' => 'eh_brucelosis_costo'],
            'IBR' => ['table' => 'eh_ibr', 'date_field' => 'eh_ibr_fecha', 'qty_field' => 'eh_ibr_dosis', 'price_field' => 'eh_ibr_costo'],
            'CBR' => ['table' => 'eh_cbr', 'date_field' => 'eh_cbr_fecha', 'qty_field' => 'eh_cbr_dosis', 'price_field' => 'eh_cbr_costo'],
            'Carbunco' => ['table' => 'eh_carbunco', 'date_field' => 'eh_carbunco_fecha', 'qty_field' => 'eh_carbunco_dosis', 'price_field' => 'eh_carbunco_costo'],
            'Garrapatas' => ['table' => 'eh_garrapatas', 'date_field' => 'eh_garrapatas_fecha', 'qty_field' => 'eh_garrapatas_dosis', 'price_field' => 'eh_garrapatas_costo'],
            'Lombrices' => ['table' => 'eh_lombrices', 'date_field' => 'eh_lombrices_fecha', 'qty_field' => 'eh_lombrices_dosis', 'price_field' => 'eh_lombrices_costo']
        ]
    ];
        ...
        foreach ($categories as $categoryName => $config) {
            ...
            if ($categoryName === 'Concentrado' || $categoryName === 'Melaza' || $categoryName === 'Sal') {
                ...
                if ($categoryName === 'Concentrado') {
                    ...
                    $sql = "SELECT 
                                eh_concentrado_racion as racion,
                                eh_concentrado_costo as costo,
                                eh_concentrado_fecha_inicio as fecha_inicio,
                                eh_concentrado_fecha_fin as fecha_fin,
                                NULL as fecha
                            FROM eh_concentrado 
                            WHERE eh_concentrado_fecha_inicio IS NOT NULL 
                            AND eh_concentrado_fecha_fin IS NOT NULL
                            AND eh_concentrado_racion > 0 
                            AND eh_concentrado_costo > 0
                            ORDER BY eh_concentrado_fecha_inicio ASC";
                } else {
                    // Get validity period from configuration
                    $validityField = $categoryName === 'Melaza' ? 'e_vencimiento_melaza' : 'e_vencimiento_sal';
                    $configQuery = "SELECT {$validityField} FROM e_vencimiento LIMIT 1";
