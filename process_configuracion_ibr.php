...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ec_ibr (ec_ibr_vacuna, ec_ibr_dosis, ec_ibr_costo, ec_ibr_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_ibr 
                    SET ec_ibr_vacuna = :vacuna, 
                        ec_ibr_dosis = :dosis, 
                        ec_ibr_costo = :costo, 
                        ec_ibr_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_ibr WHERE id = :id";
