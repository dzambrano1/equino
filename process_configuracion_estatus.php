...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO ec_estatus (ec_estatus_nombre) VALUES (:estatus)";
        ...
        case 'update':
            ...
            $sql = "UPDATE ec_estatus SET ec_estatus_nombre = :estatus WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM ec_estatus WHERE id = :id";
